...
module.exports = function( grunt ) {
    ...
    grunt.registerTask( 'notes', 'Show release notes', function() {
        ...
        grunt.log.writeln( '  1. Check WordPress for unresloved topics: https://wordpress.org/support/plugin/iworks-pwa/unresolved/');
        grunt.log.writeln( '  2. REPLY to forum threads' );
        grunt.log.writeln( '  3. Generate ARCHIVE' );
        grunt.log.writeln( '  4. RELEASE the plugin!' );
    });
